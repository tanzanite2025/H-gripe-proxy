...
| Runtime activation replacement | Done for update path | The success path feeds `CoreManager::update_config_with_force(...)` through an active-artifact-backed runtime source and the Rust restart boundary. |
