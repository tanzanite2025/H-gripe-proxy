...
mod app_init {
    ...
    pub fn generate_handlers() -> impl Fn(tauri::ipc::Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
        tauri::generate_handler![
            ...
            cmd::runtime::kernel::run_runtime_kernel_rust_go_to_rust_migration_release_closeout,
            cmd::runtime::kernel::rollback_runtime_kernel_rust_go_to_rust_migration_release_closeout,
            ...
            cmd::runtime::kernel::run_runtime_kernel_rust_route_mutation_rollback_blocker_reduction,
            ...
            cmd::runtime::kernel::run_runtime_kernel_rust_guarded_production_default_forwarding_apply,
            cmd::runtime::kernel::rollback_runtime_kernel_rust_guarded_production_default_forwarding_apply,
