...
async fn build_mihomo_fallback_retirement_execution_report(
    ...
    Ok(MihomoFallbackRetirementExecutionReport {
        ...
        warnings: vec![
            ...
            "Mihomo remains fallback for SOCKS non-loopback UDP/fragments, unsupported encrypted protocols, packet capture, route install, and full binary removal".into(),
        ],
        facts: vec![
...
fn retained_fallback_scope() -> Vec<String> {
    vec![
        "SOCKS non-loopback UDP and fragmented UDP".into(),
