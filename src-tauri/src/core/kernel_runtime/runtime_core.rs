...
pub(super) fn rust_runtime_supported_safe_subset() -> Vec<String> {
    vec![
...
pub(super) fn rust_runtime_fallback_boundaries() -> Vec<String> {
    vec![
...
pub(super) fn parse_kernel_runtime_kind(requested_runtime_kind: Option<String>) -> KernelRuntimeKind {
...
pub(super) async fn rust_kernel_runtime_supported_subset_report() -> Result<RustKernelRuntimeSupportedSubsetReport> {
...
pub(super) fn rust_kernel_runtime_health_state_report(
    opt_in_ready: bool,
