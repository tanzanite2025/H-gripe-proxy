...
use crate::core::kernel_runtime::{
    ...
    RustFinalMihomoBinaryRemovalGateReport, RustGeoipDatabaseBlockerReport, RustGoToRustMigrationReleaseCloseoutReport,
    ...
    rollback_final_mihomo_binary_removal_gate, rollback_go_to_rust_migration_release_closeout,
    ...
    rust_fallback_retirement_readiness_manifest, rust_final_mihomo_binary_removal_gate,
    rust_geoip_database_blocker_reduction, rust_go_to_rust_migration_release_closeout,
...
#[tauri::command]
pub async fn run_runtime_kernel_rust_manual_default_path_removal_review(
    explicit_opt_in: bool,
    operator_approved: bool,
) -> CmdResult<RustManualDefaultPathRemovalReviewReport> {
    rust_manual_default_path_removal_review(explicit_opt_in, operator_approved)
        .await
        .stringify_err()
}

#[tauri::command]
pub async fn run_runtime_kernel_rust_operator_default_path_cutover(
    explicit_opt_in: bool,
    operator_approved: bool,
    commit_cutover: bool,
) -> CmdResult<RustOperatorDefaultPathCutoverReport> {
    rust_operator_default_path_cutover(explicit_opt_in, operator_approved, commit_cutover)
        .await
        .stringify_err()
}
...
#[tauri::command]
pub async fn run_runtime_kernel_rust_route_mutation_rollback_blocker_reduction(
    explicit_opt_in: bool,
) -> CmdResult<RustRouteMutationRollbackBlockerReport> {
    rust_route_mutation_rollback_blocker_reduction(explicit_opt_in)
        .await
        .stringify_err()
}

#[tauri::command]
pub async fn run_runtime_kernel_rust_packet_leak_hold_blocker_reduction(
    explicit_opt_in: bool,
...
#[tauri::command]
pub async fn run_runtime_kernel_rust_plugin_binary_compatibility_blocker_reduction(
    explicit_opt_in: bool,
) -> CmdResult<RustPluginBinaryCompatibilityBlockerReport> {
    rust_plugin_binary_compatibility_blocker_reduction(explicit_opt_in)
        .await
        .stringify_err()
}
...
#[tauri::command]
pub async fn run_runtime_kernel_rust_fallback_retirement_closeout(
    explicit_opt_in: bool,
    operator_approved: bool,
    commit_closeout: bool,
    verify_post_closeout: bool,
) -> CmdResult<RustFallbackRetirementCloseoutReport> {
    Box::pin(rust_fallback_retirement_closeout(
        explicit_opt_in,
        operator_approved,
        commit_closeout,
...
#[tauri::command]
pub async fn rollback_runtime_kernel_rust_fallback_retirement_closeout(
    explicit_opt_in: bool,
) -> CmdResult<RustFallbackRetirementCloseoutReport> {
...
#[tauri::command]
pub async fn run_runtime_kernel_rust_go_to_rust_migration_release_closeout(
    explicit_opt_in: bool,
    operator_approved: bool,
    commit_release_closeout: bool,
    verify_packaging_cleanup: bool,
) -> CmdResult<RustGoToRustMigrationReleaseCloseoutReport> {
    Box::pin(rust_go_to_rust_migration_release_closeout(
        explicit_opt_in,
        operator_approved,
...
#[tauri::command]
pub async fn rollback_runtime_kernel_rust_go_to_rust_migration_release_closeout(
    explicit_opt_in: bool,
) -> CmdResult<RustGoToRustMigrationReleaseCloseoutReport> {
    Box::pin(rollback_go_to_rust_migration_release_closeout(explicit_opt_in))
        .await
        .stringify_err()
}
...
#[tauri::command]
pub async fn run_runtime_kernel_rust_dns_system_resolver_leak_blocker_reduction(
    explicit_opt_in: bool,
...
#[tauri::command]
pub async fn run_runtime_kernel_rust_tun_device_lifecycle_blocker_reduction(
    explicit_opt_in: bool,
) -> CmdResult<RustTunDeviceLifecycleBlockerReport> {
    rust_tun_device_lifecycle_blocker_reduction(explicit_opt_in)
        .await
        .stringify_err()
}
