...
use crate::{
    ...
    core::{
        ...
        kernel_runtime::{
            ...
            KernelLoopbackR6RustDefaultCanaryReport, KernelLoopbackR7RustDefaultCutoverReport,
            KernelReplacementReadiness, KernelRuleShadowEvidenceReport, KernelRuntimePreflightReport,
            KernelRuntimeSelectionScaffoldReport, KernelShadowComponentsReport, RustKernelRuntimeCandidateReport,
            kernel_runtime_selection_scaffold, mihomo_kernel_adapter_capability_report, mihomo_kernel_apply_preflight,
