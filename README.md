...
- TUN/route blocker reductions: route snapshots, route mutation apply/rollback plans, synthetic TUN lifecycle evidence, packet-capture hold evidence, packet leak hold evidence, and guarded TUN/packet-capture apply/rollback checkpoints, and fallback-retirement closeout manifests, and final Mihomo binary removal gate manifests, and release packaging closeout manifests, and sidecar invocation retirement runtime changes, and Mihomo service startup retirement, runtime service/sidecar cleanup, and plugin mutation/recovery API retirement.
...
- Mihomo read API retirement after plugin mutation/recovery API retirement.
