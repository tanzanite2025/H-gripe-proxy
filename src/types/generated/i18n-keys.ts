...
export const translationKeys = [
  ...
  'home.components.proxyDetection.title',
  'home.components.proxyDetection.actions.retry',
  'home.components.proxyDetection.actions.close',
  'home.components.proxyDetection.actions.advice',
  'home.components.proxyDetection.actions.refresh',
  ...
  'home.components.proxyDetection.summary.effective.ipChanged',
  'home.components.proxyDetection.summary.effective.locationChanged',
  'home.components.proxyDetection.summary.sameEgress.title',
  'home.components.proxyDetection.summary.sameEgress.description',
  'home.components.proxyDetection.summary.incomplete.title',
  'home.components.proxyDetection.summary.incomplete.description',
  'home.components.proxyDetection.assessment.effective',
  'home.components.proxyDetection.assessment.sameEgress',
  'home.components.proxyDetection.assessment.runtimeRisk',
  'home.components.proxyDetection.assessment.inconclusive',
  'home.components.proxyDetection.confidence.high',
  'home.components.proxyDetection.confidence.medium',
  'home.components.proxyDetection.confidence.low',
  'home.components.proxyDetection.observationPath.directVsCore',
  'home.components.proxyDetection.observationPath.directOnly',
  'home.components.proxyDetection.observationPath.coreOnly',
  'home.components.proxyDetection.core.running',
  'home.components.proxyDetection.core.stopped',
  'home.components.proxyDetection.runtimeRisk.coreNotRunning',
  'home.components.proxyDetection.runtimeRisk.directEgressUnavailable',
  'home.components.proxyDetection.runtimeRisk.localCoreProxyUnreachable',
  'home.components.proxyDetection.runtimeRisk.proxyReputationUnavailable',
  'home.components.proxyDetection.alerts.observationIncomplete',
  'home.components.proxyDetection.adviceDialog.title',
  'home.components.proxyDetection.advice.ipChanged',
  'home.components.proxyDetection.advice.locationChanged',
  'home.components.proxyDetection.advice.reputation',
  'home.components.proxyDetection.advice.proxyEffective',
  'home.components.proxyDetection.advice.sameEgress',
  'home.components.proxyDetection.advice.observationIncomplete',
  'home.components.proxyDetection.advice.noClearChange',
  'home.components.proxyDetection.ipType.datacenter',
  'home.components.proxyDetection.ipType.residential',
  'home.components.proxyDetection.ipType.mobile',
  'home.components.proxyDetection.ipType.education',
  'home.components.proxyDetection.ipType.unknown',
  'home.components.proxyDetection.residentialState.notResidential',
  'home.components.proxyDetection.residentialState.observedResidential',
  'home.components.proxyDetection.residentialState.verifiedResidential',
  'home.components.proxyDetection.residentialState.unknown',
  'home.components.proxyDetection.patterns.reputation',
  'home.components.proxyDetection.patterns.asn',
  ...
  'layout.components.navigation.tabs.networkDiagnostic',
  'layout.components.navigation.tabs.dns',
  'layout.components.navigation.tabs.security',
  'layout.components.navigation.tabs.webTest',
  ...
  'profiles.page.feedback.subscriptionUpdate.transports.direct',
  ...
  'profiles.components.menu.updateHistory',
  ...
  'profiles.components.profileItem.subscriptionStatus.active',
  'profiles.components.profileItem.subscriptionStatus.attemptStarted',
  'profiles.components.profileItem.subscriptionStatus.failedAt',
  'profiles.components.profileItem.subscriptionStatus.updated',
  'profiles.components.profileItem.subscriptionStatus.updating',
  'profiles.components.profileItem.updateHistory.title',
  'profiles.components.profileItem.updateHistory.latestAttempt',
  'profiles.components.profileItem.updateHistory.noEvents',
  'profiles.components.profileItem.updateHistory.artifacts',
  'profiles.components.profileItem.updateHistory.noArtifacts',
  'profiles.components.profileItem.updateHistory.attemptStarted',
  'profiles.components.profileItem.updateHistory.active',
  'profiles.components.profileItem.updateHistory.rawBody',
  'profiles.components.profileItem.updateHistory.normalizedYaml',
  'profiles.components.profileItem.updateHistory.diagnostics',
  ...
  'proxies.page.provider.actions.healthCheck',
  'proxies.page.provider.health.healthy',
  'proxies.page.provider.health.unhealthy',
  'proxies.page.provider.health.unknown',
  'proxies.page.provider.health.lastChecked',
  ...
  'rules.dialogs.create.title',
  'rules.dialogs.create.ok',
  'rules.dialogs.create.cancel',
  'rules.dialogs.create.ruleType',
  'rules.dialogs.create.payload',
  'rules.dialogs.create.payloadPlaceholder',
  'rules.dialogs.create.proxy',
  'rules.dialogs.create.proxyPlaceholder',
  ...
  'settings.sections.clash.form.fields.findProcessMode',
  ...
  'settings.sections.clash.form.options.findProcessMode.always',
  'settings.sections.clash.form.options.findProcessMode.strict',
  'settings.sections.clash.form.options.findProcessMode.off',
  ...
  'shared.labels.artifact',
  'shared.labels.error',
  'shared.labels.stage',
  'shared.labels.status',
  'shared.labels.time',
  'shared.labels.transport',
  ...
  'shared.feedback.errors.core_panic_recovered',
