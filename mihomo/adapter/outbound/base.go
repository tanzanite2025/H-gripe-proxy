...
// AntiDPIOption controls anti-DPI features for VMess/VLESS connections.
type AntiDPIOption struct {
	Enabled      bool   `proxy:"enabled,omitempty"`
	PaddingMode  string `proxy:"padding-mode,omitempty"` // "random", "size_uniform", "none"
	MinPadding   int    `proxy:"min-padding,omitempty"`
	MaxPadding   int    `proxy:"max-padding,omitempty"`
	JitterMs     int    `proxy:"jitter-ms,omitempty"`
	BurstBefore  int    `proxy:"burst-before,omitempty"`
	DummyTraffic bool   `proxy:"dummy-traffic,omitempty"`
}
