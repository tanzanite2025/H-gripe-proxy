...
type RuleWrapper interface {
	...
	// Source returns where this rule came from ("profile", "provider:<name>", "sub-rule:<name>")
	Source() string
	// SetSource sets the rule source
	SetSource(source string)

	// IsDeleted return rule is soft-deleted or not
	IsDeleted() bool
	// SetDeleted to soft-delete/undelete a rule
	SetDeleted(v bool)
	...
	// Hit records a rule match hit for statistics
	Hit()
